...
export function ApprovalsNewForm() {
  ...
  return (
    <>
      <GlobalLoadingOverlay open={isPending && isSubmitting} message="確認画面へ移動中..." />
      <form onSubmit={handleSubmit(onSubmit)}>
        <Card>
          ...
          <CardFooter className="flex justify-between">
            ...
            <Button type="submit" className="" disabled={isPending} variant="primary">
              {isPending ? <ButtonLoadingContent text="送信中..." /> : '確認'}
            </Button>
          </CardFooter>
